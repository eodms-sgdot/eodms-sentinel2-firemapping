...
def search_in_stac_api(bbox, reported_date):
    ...
    end_date = reported_date - timedelta(days=1)
...
resDataFileName = "./Results/refImageFordNBR.csv"
with open(resDataFileName, mode='w', newline='') as file:
    writer = csv.writer(file)
    # Usage example:
    col_headers = [['FIRE_ID', 'REP_DATE', 'RefS2FileName', 'CloudCover', 'BestDate']]
    ...
    if REP_YEAR == 2020:
        ...
        if SIZE_HA > 200 and SRC_AGENCY == 'BC':
            ...
            if not items:
                ...
                s2FilePath = f"./downloadedData/Sentinel2/stac_api_data/{FIRE_ID}/RefImage/{s2FileNmLower}"
